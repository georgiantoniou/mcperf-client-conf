...
## Client Side C0-FG_PE-TICKS_ON-UNC_FIXED ##
~/mcperf-client-conf/client-conf-scripts/set-client-configuration.sh main 0001111 node0,node2,node3,node4,node5 ~/mcperf-client-conf/client-conf-scripts/ node0,~/data/memcached-motivation-smt/C0-FG_PE-TICKS_ON-UNC_FIXED-S-SMT_OFF

## Run experiment
ssh ganton12@node0 "cd ~/mcperf-client-conf/; nohup python3 ./run_experiment.py memcached-motivation-smt/C0-FG_PE-TICKS_ON-UNC_FIXED-S-SMT_OFF >> ~/nohup.out 2>&1 &"
